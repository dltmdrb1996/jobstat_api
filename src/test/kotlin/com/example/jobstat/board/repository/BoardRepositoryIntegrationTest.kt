package com.example.jobstat.board.repository
...
class BoardRepositoryIntegrationTest : JpaIntegrationTestSupport() {
    ...
    inner class FindBoardTest {
        ...
        fun findByCategorySuccess() {
            // Given
            val anotherCategory = categoryRepository.save(BoardCategory.create("ANOTHER_CATEGORY", "Another Category", "Another Description"))
