...
import com.example.jobstat.community_read.repository.impl.RedisBoardCountRepository
...
import com.example.jobstat.core.event.payload.BoardRankingUpdatedEventPayloadFixture
import com.example.jobstat.core.event.payload.BoardUpdatedEventPayloadFixture
import com.example.jobstat.core.event.payload.BoardViewedEventPayloadFixture
...
class CommunityEventHandlerVerLuaTest {
    ...
    inner class HandleBoardRankingUpdated {
        ...
        private val rankings = listOf(BoardRankingUpdatedEventPayload.RankingEntry(10L, 500.0))
