package com.example.jobstat.statistics_read.core.core_mongo_base.config

import com.example.jobstat.statistics_read.core.core_mongo_base.converter.RankingScoreWriteConverter
...
@Configuration
class MongoConfig(
    private val rankingScoreReadConverter: com.example.jobstat.statistics_read.core.core_mongo_base.converter.RankingScoreReadConverter,
