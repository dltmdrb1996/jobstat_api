...
//
//        val handlerMethod = getHandlerMethod(request)
//        val isPublicWithTokenCheck = isPublicWithTokenCheckEndpoint(handlerMethod)
//        val requiresAdminAuth = requiresAdminAuth(handlerMethod)
//
//        try {
...
//        }
//
//    private fun isPublicWithTokenCheckEndpoint(handlerMethod: HandlerMethod?): Boolean =
//        when {
//            handlerMethod == null -> false
...
//        }
//
//    private fun requiresAdminAuth(handlerMethod: HandlerMethod?): Boolean =
//        when {
//            handlerMethod == null -> false
