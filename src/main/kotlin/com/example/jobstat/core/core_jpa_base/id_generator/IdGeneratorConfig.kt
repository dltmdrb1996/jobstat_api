package com.example.jobstat.core.core_jpa_base.id_generator // 패키지 변경 권장

import com.example.jobstat.core.core_jpa_base.id_generator.sharded.ShardedSnowflake
import org.hibernate.id.IdentifierGenerator // @ConditionalOnClass 확인용
