 ...
 */
inline fun <reified T : Any> DataSerializer.deserialize(data: String): T? = deserialize(data, T::class)

/**
 * String 확장 함수: JSON 문자열을 지정한 타입으로 역직렬화
 */
inline fun <reified T : Any> String.deserializeAs(dataSerializer: DataSerializer): T? = dataSerializer.deserialize(this, T::class)
