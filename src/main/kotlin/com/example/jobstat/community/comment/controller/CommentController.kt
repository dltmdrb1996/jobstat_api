package com.example.jobstat.community.comment.controller

import com.example.jobstat.community.board.usecase.get.GetAuthorActivities
import com.example.jobstat.community.comment.usecase.get.GetCommentDetail
import com.example.jobstat.community.comment.usecase.get.GetCommentsByAuthor
...
import com.example.jobstat.community.comment.usecase.command.CreateComment
import com.example.jobstat.community.comment.usecase.command.DeleteComment
import com.example.jobstat.community.comment.usecase.command.UpdateComment
...
//    ): ResponseEntity<ApiResponse<GetCommentsByAuthor.Response>> = ApiResponse.ok(getCommentsByAuthor(GetCommentsByAuthor.Request(author, page)))
    ...
    ): ResponseEntity<ApiResponse<GetCommentsByBoardIdAfter.Response>> = 
        ApiResponse.ok(getCommentsByBoardIdAfter(GetCommentsByBoardIdAfter.Request(boardId, lastCommentId, limit)))
