...
class RedisCommentCountRepository(
    ...
    override fun getTotalCount(): Long {
        return redisTemplate.opsForValue().get(COMMENT_TOTAL_COUNT_KEY)?.toLong() ?: 0
    }

    /**
     * 파이프라인에서 게시글별 댓글 카운트 증감
     */
    override fun applyBoardCommentCountInPipeline(conn: StringRedisConnection, boardId: Long, delta: Long) {
        val key = BOARD_COMMENT_COUNT_KEY_FORMAT.format(boardId)
     ...
     */
    override fun applyTotalCountInPipeline(conn: StringRedisConnection, delta: Long) {
