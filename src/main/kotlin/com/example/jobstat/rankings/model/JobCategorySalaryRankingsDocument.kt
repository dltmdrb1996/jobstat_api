...
class JobCategorySalaryRankingsDocument(
    ...
    @Field("metrics")
    override val metrics: JobCategorySalaryMetrics,
    @Field("rankings")
    override val rankings: List<JobCategorySalaryRankingEntry>,
    ...
    data class JobCategorySalaryMetrics(
        ...
        val salaryAnalysis: SalaryAnalysis,
    ) : RankingMetrics {
        data class SalaryAnalysis(
            @Field("industry_comparison")
            val industryComparison: Map<Long, SalaryComparison>,
            @Field("experience_impact")
            val experienceImpact: Map<String, Double>,
            @Field("company_size_variance")
            val companySizeVariance: Map<String, Double>,
        ) {
    ...
    data class JobCategorySalaryRankingEntry(
        ...
        data class SalaryDetails(
            ...
            @Field("salary_growth_rate")
            val salaryGrowthRate: Double,
