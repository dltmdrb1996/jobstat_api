...
internal class RoleRepositoryImpl(
    ...
    override fun findById(id: Long): Role = 
        roleJpaRepository.findById(id).orThrowNotFound("id", id)

    override fun findByName(name: String): Role = 
        roleJpaRepository.findByName(name).orThrowNotFound("name", name)
    ...
    override fun existsById(id: Long): Boolean = 
        roleJpaRepository.existsById(id)

    override fun existsByName(name: String): Boolean = 
        roleJpaRepository.existsByName(name)
}