...
/**
 * 특정 카테고리의 게시글 ID 목록을 커서 기반 페이징으로 조회하는 유스케이스
 * - 특정 ID 이후부터 카테고리별 게시글 ID 목록 반환
 */
@Service
class GetCategoryBoardIdsByCursorUseCase(
    ...
    @Schema(description = "카테고리별 게시글 ID 목록 (커서 기반) 조회 요청")
    data class Request(
