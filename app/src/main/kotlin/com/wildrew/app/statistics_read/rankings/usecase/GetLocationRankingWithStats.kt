...
import com.wildrew.app.statistics_read.rankings.model.rankingtype.LocationRankingType
...
import com.wildrew.app.statistics_read.stats.document.LocationStatsDocument
    ...
    fun execute(request: Request): Response =
        with(request) {
            ...
            rankingAnalysisService
                .findStatsWithRanking<LocationStatsDocument>(
