...
) : EventHandlingUseCase<EventType, com.wildrew.jobstat.core.core_event.model.payload.board.BoardRankingUpdatedEventPayload, Unit>() {
    override val eventType: EventType = EventType.BOARD_RANKING_UPDATED

    override fun execute(payload: com.wildrew.jobstat.core.core_event.model.payload.board.BoardRankingUpdatedEventPayload) {
