...
import com.wildrew.jobstat.statistics_read.rankings.model.rankingtype.LocationRankingType
...
@Service
class GetLocationRanking(
    private val rankingAnalysisService: RankingAnalysisService,
    private val validator: Validator,
) : UseCase<GetLocationRanking.Request, GetLocationRanking.Response> {
    ...
    @Schema(name = "GetLocationRankingResponse", description = "지역 순위(경량) 조회 응답")
    data class Response(
        @Schema(description = "순위 타입", example = "LOCATION_SALARY")
        val rankingType: LocationRankingType,
