...
@Service
class GetRemoteWorkTypeRanking(
    private val rankingAnalysisService: RankingAnalysisService,
    private val validator: Validator,
) : UseCase<GetRemoteWorkTypeRanking.Request, GetRemoteWorkTypeRanking.Response> {
    ...
    @Schema(name = "GetRemoteWorkTypeRankingResponse", description = "원격 근무 형태 순위(경량) 조회 응답")
    data class Response(
        @Schema(description = "순위 타입", example = "REMOTE_WORK_TYPE_POSTING_COUNT")
        val rankingType: RemoteWorkTypeRankingType,
