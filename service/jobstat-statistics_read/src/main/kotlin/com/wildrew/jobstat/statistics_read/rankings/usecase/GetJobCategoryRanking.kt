...
@Service
class GetJobCategoryRanking(
    private val rankingAnalysisService: RankingAnalysisService,
    private val validator: Validator,
) : UseCase<GetJobCategoryRanking.Request, GetJobCategoryRanking.Response> {
    ...
    @Schema(name = "GetJobCategoryRankingResponse", description = "직무 카테고리 순위(경량) 조회 응답")
    data class Response(
        @Schema(description = "순위 타입", example = "JOB_CATEGORY_SALARY")
        val rankingType: JobCategoryRankingType,
