...
@Service
class GetEducationRanking(
    private val rankingAnalysisService: RankingAnalysisService,
    private val validator: Validator,
) : UseCase<GetEducationRanking.Request, GetEducationRanking.Response> {
    ...
    @Schema(name = "GetEducationRankingResponse", description = "학력 순위(경량) 조회 응답")
    data class Response(
        @Schema(description = "순위 타입", example = "EDUCATION_SALARY")
        val rankingType: EducationRankingType,
