...
@Service
class GetContractTypeRanking(
    private val rankingAnalysisService: RankingAnalysisService,
    private val validator: Validator,
) : UseCase<GetContractTypeRanking.Request, GetContractTypeRanking.Response> {
    ...
    @Schema(name = "GetContractTypeRankingResponse", description = "계약 형태 순위(경량) 조회 응답")
    data class Response(
        @Schema(description = "순위 타입", example = "CONTRACT_TYPE_POSTING_COUNT")
        val rankingType: ContractTypeRankingType,
