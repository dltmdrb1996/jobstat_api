...
@Service
class GetCompanySizeRankingWithStats(
    private val rankingAnalysisService: RankingAnalysisService,
    private val validator: Validator,
) : UseCase<GetCompanySizeRankingWithStats.Request, GetCompanySizeRankingWithStats.Response> {
    companion object {
        val COMPANY_SIZE_RANKING_TYPES =
            setOf(
    ...
    @Schema(name = "GetCompanySizeRankingWithStatsResponse", description = "회사 규모 순위 조회 응답")
    data class Response(
