...
@Service
class GetBenefitRanking(
    private val rankingAnalysisService: RankingAnalysisService,
    private val validator: Validator,
) : UseCase<GetBenefitRanking.Request, GetBenefitRanking.Response> {
    ...
    @Schema(name = "GetBenefitRankingResponse", description = "복리후생 순위(경량) 조회 응답")
    data class Response(
        @Schema(description = "순위 타입", example = "BENEFIT_POSTING_COUNT")
        val rankingType: BenefitRankingType,
