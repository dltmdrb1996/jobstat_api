...
import com.wildrew.jobstat.statistics_read.rankings.model.rankingtype.CertificationRankingType
...
@Service
class GetCertificationRanking(
    private val rankingAnalysisService: RankingAnalysisService,
    private val validator: Validator,
) : UseCase<GetCertificationRanking.Request, GetCertificationRanking.Response> {
    ...
    @Schema(name = "GetCertificationRankingResponse", description = "자격증 순위(경량) 조회 응답")
    data class Response(
        @Schema(description = "순위 타입", example = "CERTIFICATION_SALARY")
        val rankingType: CertificationRankingType,
