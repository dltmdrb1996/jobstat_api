...
import com.wildrew.jobstat.statistics_read.rankings.model.rankingtype.ExperienceRankingType
...
@Service
class GetExperienceRanking(
    private val rankingAnalysisService: RankingAnalysisService,
    private val validator: Validator,
) : UseCase<GetExperienceRanking.Request, GetExperienceRanking.Response> {
    ...
    @Schema(name = "GetExperienceRankingResponse", description = "경력 순위(경량) 조회 응답")
    data class Response(
        @Schema(description = "순위 타입", example = "EXPERIENCE_POSTING_COUNT")
        val rankingType: ExperienceRankingType,
