...
@Service
class GetCompanyRanking(
    private val rankingAnalysisService: RankingAnalysisService,
    private val validator: Validator,
) : UseCase<GetCompanyRanking.Request, GetCompanyRanking.Response> {
    ...
    @Schema(name = "GetCompanyRankingResponse", description = "회사 순위(경량) 조회 응답")
    data class Response(
        @Schema(description = "순위 타입", example = "COMPANY_SALARY")
        val rankingType: CompanyRankingType,
