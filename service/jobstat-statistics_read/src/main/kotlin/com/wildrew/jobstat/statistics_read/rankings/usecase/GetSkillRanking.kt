...
class GetSkillRanking(
...
) : UseCase<GetSkillRanking.Request, GetSkillRanking.Response> {
    ...
    @Schema(name = "GetSkillRankingResponse", description = "기술 순위(경량) 조회 응답")
    data class Response(
        @Schema(description = "순위 타입", example = "SKILL_SALARY")
        val rankingType: SkillRankingType,
